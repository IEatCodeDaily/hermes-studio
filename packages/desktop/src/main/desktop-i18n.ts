...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    'tray.show': 'Show Olympus',
    'tray.hide': 'Hide Olympus',
    'tray.checkForUpdates': 'Check for Updates',
    'tray.openAtLogin': 'Open at Login',
    'tray.quit': 'Quit Olympus',
    'update.upToDateTitle': 'Olympus',
    'update.upToDateMessage': 'Olympus is up to date.',
    'update.checkingTitle': 'Olympus',
    ...
    'update.availableMessage': 'Olympus {version} is available.',
    'update.downloading': 'The update is downloading in the background.',
    'update.readyTitle': 'Update ready',
    'update.readyMessage': 'Olympus {version} is ready to install.',
    ...
    'update.failedMessage': 'Could not check for Olympus updates.',
    ...
    'desktop.downloadCloudflareDetail': 'Use the Olympus download proxy.',
  ...
  zh: {
    ...
    'desktop.downloadCloudflareDetail': '使用 Olympus 下载代理。',
  ...
  'zh-TW': {
    'tray.show': '顯示 Olympus',
    'tray.hide': '隱藏 Olympus',
    'tray.checkForUpdates': '檢查更新',
    'tray.openAtLogin': '開機啟動',
    'tray.quit': '結束 Olympus',
    'update.upToDateTitle': 'Olympus',
    'update.upToDateMessage': 'Olympus 已是最新版本。',
    'update.checkingTitle': 'Olympus',
    ...
    'desktop.downloadCloudflareDetail': '使用 Olympus 下載代理。',
  ...
  ja: {
    ...
    'desktop.downloadCloudflareDetail': 'Olympus のダウンロードプロキシを使用します。',
  ...
  ko: {
    ...
    'update.failedMessage': 'Olympus 업데이트를 확인할 수 없습니다.',
    ...
    'desktop.downloadCloudflareDetail': 'Olympus 다운로드 프록시를 사용합니다.',
  ...
  fr: {
    'tray.show': 'Afficher Olympus',
    'tray.hide': 'Masquer Olympus',
    'tray.checkForUpdates': 'Rechercher les mises a jour',
    'tray.openAtLogin': 'Ouvrir a la connexion',
    'tray.quit': 'Quitter Olympus',
    'update.upToDateTitle': 'Olympus',
    'update.upToDateMessage': 'Olympus est a jour.',
    'update.checkingTitle': 'Olympus',
    ...
    'update.availableMessage': 'Olympus {version} est disponible.',
    'update.downloading': 'La mise a jour se telecharge en arriere-plan.',
    'update.readyTitle': 'Mise a jour prete',
    'update.readyMessage': 'Olympus {version} est pret a etre installe.',
    ...
    'update.failedMessage': 'Impossible de rechercher les mises a jour de Olympus.',
    ...
    'desktop.downloadCloudflareDetail': 'Utilise le proxy de telechargement Olympus.',
  ...
  es: {
    'tray.show': 'Mostrar Olympus',
    'tray.hide': 'Ocultar Olympus',
    'tray.checkForUpdates': 'Buscar actualizaciones',
    'tray.openAtLogin': 'Abrir al iniciar sesion',
    'tray.quit': 'Salir de Olympus',
    'update.upToDateTitle': 'Olympus',
    'update.upToDateMessage': 'Olympus esta actualizado.',
    'update.checkingTitle': 'Olympus',
    ...
    'update.availableMessage': 'Olympus {version} esta disponible.',
    'update.downloading': 'La actualizacion se esta descargando en segundo plano.',
    'update.readyTitle': 'Actualizacion lista',
    'update.readyMessage': 'Olympus {version} esta listo para instalarse.',
    ...
    'update.failedMessage': 'No se pudieron buscar actualizaciones de Olympus.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa el proxy de descarga de Olympus.',
  ...
  de: {
    'tray.show': 'Olympus anzeigen',
    'tray.hide': 'Olympus ausblenden',
    'tray.checkForUpdates': 'Nach Updates suchen',
    'tray.openAtLogin': 'Beim Anmelden offnen',
    'tray.quit': 'Olympus beenden',
    'update.upToDateTitle': 'Olympus',
    'update.upToDateMessage': 'Olympus ist auf dem neuesten Stand.',
    'update.checkingTitle': 'Olympus',
    ...
    'update.availableMessage': 'Olympus {version} ist verfugbar.',
    'update.downloading': 'Das Update wird im Hintergrund heruntergeladen.',
    'update.readyTitle': 'Update bereit',
    'update.readyMessage': 'Olympus {version} ist zur Installation bereit.',
    ...
    'update.failedMessage': 'Updates fur Olympus konnten nicht gepruft werden.',
    ...
    'desktop.downloadCloudflareDetail': 'Verwendet den Olympus Download-Proxy.',
  ...
  pt: {
    ...
    'tray.quit': 'Sair do Olympus',
    'update.upToDateTitle': 'Olympus',
    'update.upToDateMessage': 'Olympus esta atualizado.',
    'update.checkingTitle': 'Olympus',
    ...
    'update.availableMessage': 'Olympus {version} esta disponivel.',
    'update.downloading': 'A atualizacao esta sendo baixada em segundo plano.',
    'update.readyTitle': 'Atualizacao pronta',
    'update.readyMessage': 'Olympus {version} esta pronto para instalar.',
    ...
    'update.failedMessage': 'Nao foi possivel verificar atualizacoes do Olympus.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa o proxy de download do Olympus.',
