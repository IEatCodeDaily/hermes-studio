...
const DISPLAY_COMMAND = basename(process.argv[1] || 'hermes-studio-mcp') || 'hermes-studio-mcp'
...
const moduleHints = {
  ...
  Config: {
    purpose: 'Read and update Hermes Studio configuration.',
...
const authArgumentProperties = {
  token: {
    type: 'string',
    description: 'Optional Hermes Studio bearer token. Usually omit this and pass profile so the MCP server can read the temporary profile token.',
  },
  profile: {
    type: 'string',
