...
openapi.paths['/api/chat-run/runs'] = {
  post: {
    ...
    description: 'Starts an Hermes Studio chat run through the chat-run transport and waits for a terminal result. Use this from HTTP/MCP callers that cannot consume Socket.IO streams.',
